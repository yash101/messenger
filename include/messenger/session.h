...
struct MessengerSession* messenger_Session_new();
struct MessengerSession* messenger_Session_destroy(struct MessengerSession* s);
struct sockaddr_in6 messenger_Session_getRemoteAddress(struct MessengerSession* s);
struct sockaddr_in6 messenger_Session_getLocalAddress(struct MessengerSession* s);
